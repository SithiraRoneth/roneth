...
function About() {
    ...
    return (
        <>
            <div
                className="flex flex-col md:flex-row items-center justify-center md:justify-start px-6 md:px-16 py-12 text-white md:mt-28 md:ml-52">
                <div
                    className="relative w-full md:w-[350px] h-auto md:h-[450px] grayscale mb-8 md:mb-0 overflow-hidden rounded-lg ">
